...
echo -e "${BLUE}===== NestJS RBAC Testing Script =====${NC}\n"
...
echo "Testing USER role endpoints..."
test_endpoint "USER" "/auth/profile" "GET" 200
test_endpoint "USER" "/rbac/admin" "GET" 403
test_endpoint "USER" "/rbac/organizer" "GET" 403
test_endpoint "USER" "/rbac/staff" "GET" 403

echo -e "\nTesting ADMIN role endpoints..."
test_endpoint "ADMIN" "/auth/profile" "GET" 200
test_endpoint "ADMIN" "/rbac/admin" "GET" 200
test_endpoint "ADMIN" "/rbac/organizer" "GET" 403
test_endpoint "ADMIN" "/rbac/staff" "GET" 403
